...
# comfortably exceeds the in-app solve backstop (SOLVER_TIMEOUT_S, default 120s).
CMD ["sh", "-c", "gunicorn --workers 1 --threads 8 --timeout 180 --bind 0.0.0.0:${PORT} app:app"]
